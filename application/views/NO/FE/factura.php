            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-header">
                        <?php if($paciente->credito_fiscal == ""){ ?>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <?php
                                ...
                                echo '<h6 class="text-danger">Cuenta facturada <strong>'.$paciente->notaFactura.' #'.$paciente->credito_fiscal.'</strong></h6>';
                            }
                        ?>
                    </div>
                    <div class="row">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/sellar_factura" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td><strong>Nombre:</strong></td>
                                            <td><?php echo !isset($anexo->nombrePaciente) ? /* $paciente->nombrePaciente */ "" : $anexo->nombrePaciente; ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>DUI:</strong></td>
                                            <td><?php echo !isset($anexo->duiPaciente) ? /* $paciente->duiPaciente */ "" : $anexo->duiPaciente; ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Teléfono:</strong></td>
                                            <td><?php echo !isset($anexo->telefonoPaciente) ? /* $paciente->telefonoPaciente */ "" : $anexo->telefonoPaciente; ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Correo:</strong></td>
                                            <td><?php echo !isset($anexo->correoPaciente) ? /* $paciente->correoPaciente */ "" : $anexo->correoPaciente; ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Dirección:</strong></td>
                                            <td><?php echo !isset($anexo->direccionPaciente) ? /* $paciente->direccionPaciente */ "" : $anexo->direccionPaciente; ?></td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach ($medicamentosHoja as $row) {
                                                $interno += (($row->precioInsumo * $row->cantidadInsumo));
                                            }
                                            ...
                                            echo '<tr>
                                                        ...
                                                        <td class="text-center">'.$detalleFactura.'</td>
                                                        ...
                                                        <td class="text-center"> $'.number_format($totalI, 2).'
                                                            ...
                                                            <input type="hidden" value="'.$detalleFactura.'" id="detalleFactura" name="detalleFactura"></td>
                                                    </tr>';
                                            ...
                                            echo '<tr id="filaExterno">
                                                    ...
                                                    <td class="text-center">$'.number_format($totalE, 2).'
                                                        <input type="hidden" value="'.round($iva, 2).'" id="ivaE" name="ivaE">
                                                        <input type="hidden" value="'.round($subTotal, 2).'" id="subTotalE" name="subTotalE">
                                                        <input type="hidden" value="'.round($totalE, 2).'" id="totalExterno" name="totalExterno"></td>
                            ...
                            <?php
                                if(!is_null($anexo) && $paciente->credito_fiscal == ""){
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary mt-4 d-inline w-20" type="submit"> Enviar datos <i class="fa fa-arrow-right"></i></button>
                                    </div>
                            ...
                            <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/actualizar_anexo_paciente" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo @$anexo->duiPaciente == "" ? $paciente->duiPaciente : $anexo->duiPaciente; ?>" id="duiPaciente" name="duiPaciente" placeholder="DUI del paciente" required>
                                        <div class="invalid-tooltip">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12 cl-lg-6">
                                        ...
                                        <select class="form-control" value="<?php echo @$anexo->idDepartamento; ?>" id="departamentoPaciente" name="departamentoPaciente">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12 cl-lg-6">
                                        ...
                                        <select class="form-control" value="<?php echo @$anexo->idMunicipio; ?>" id="municipioPaciente" name="municipioPaciente">
                                ...
                                <div class="form-group text-center mt-3">
                                    ...
                                    <button type="button" id="btnActualizarDatos" class="btn btn-primary has-icon"><i class="fa fa-save"></i> Actualizar datos </button>
                                </div>
...
<script>
    ...
    $("#departamentoPaciente").change(function () {
        ...
        $("#codigoDepartamento").val(partes[0]);
    ...
    $("#btnActualizarDatos").click(function () {
        var datos = {
            ...
            nitTercero : $("#documentoTercero").val(),
            nombreTercero : $("#razonTercero").val(),
        };
            ...
            success:function(respuesta){
                ...
                if (Object.keys(registro).length > 0){
                    if(registro.estado == 1){
                        ...
                        toastr.error('No se actualizaron los datos...', 'Aviso!');
                    }
                }else{
                    toastr.remove();
                    toastr.options = {
