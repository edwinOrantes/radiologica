                                ...
                                <table id="" class="table table-striped thead-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea rows="1"  class="form-control" id="descripcionServicio" name="descripcionServicio" required><?php echo $jsonDTE["dteJson"]["cuerpoDocumento"][0]["descripcion"]; ?></textarea>
                                            </td>
...
<script>
    ...
    $(document).on('change', '#precioServicio', function (event) {
        ...
        $("#precioServicio").val(subtotal);
        $("#ivaServicio").val(iva);
        $("#totalServicio").val(total);

        // Obteniendo valores nuevos
            $("#subTotalNew").val((subTotalOld - subtotal));
            $("#ivaNew").val((ivaOld - iva));
            $("#totalNew").val((totalOld - total));
        // Obteniendo valores nuevos
        ...
        // alert(subTotalOld +" "+ivaOld +" "+totalOld + " --- " + subtotal +" "+iva +" "+total);
