			...
			<div class="col-md-12">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-arrow has-gap">
						...
						<li class="breadcrumb-item"><a href="#">Lista de créditos fiscales</a></li>
					</ol>
				</nav>
					...
					<div class="ms-panel-header">
						<div class="row">
							...
							<div class="col-md-6 text-right">
									<a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Facturacion/agregar_ccf/0/"><i class="fa fa-plus"></i> Agregar CCF</a>
							</div>
						</div>
					</div>
										...
										<tr>
											...
											<td class="text-center"> 
												<?php 
													...
													if($row->notaCredito > 0 || $row->notaDebito > 0){
														echo ' <span class="badge badge-warning">'.$nota.'</span>';
													}
                                            ...
                                            <td>
												...
												<?php
													if($row->enContingencia == 1){
														echo '<a href="'.base_url().'Facturacion/ccf_en_contingencia/'.$row->idDTEFC.'/" target="_blank" class="text-primary" title="Enviar documento"> <i class="fa fa-check"> </i></a>';
													}else{
												?>
													...
													<div class="btn-group">
														...
														<ul class="dropdown-menu" x-placement="bottom-start">
															<li><a class="dropdown-item" target="blank" href="<?php echo base_url(); ?>Facturacion/fin_ccf/<?php echo $row->idDTEFC; ?>/0/">Ver</a></li>
															<?php
																if($row->estadoDTE == 1){
															?>
																...
																<?php
																	// Evaluando si hay nota de credito o debito
																	if($row->notaCredito > 0){
																		echo '<li class="bg-success"><a class="dropdown-item" target="blank" href="'.base_url().'Facturacion/fin_nota_credito/'.$row->notaCredito.'/0/">Ver Nota Crédito</a></li>';
																	}
																	if($row->notaDebito > 0){
																		echo '<li class="bg-success"><a class="dropdown-item" target="blank" href="'.base_url().'Facturacion/fin_nota_debito/'.$row->notaDebito.'/0/">Ver Nota Débito</a></li>';
																	}
																}
															?>
