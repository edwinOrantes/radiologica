                        ...
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/procesar_anulacion_ccf" novalidate>
                            ...
                            <div class="row">
                                ...
                                <table id="" class="table table-striped thead-primary">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input size="1" type="text" value="<?php echo $cuerpoDocumento[0]["numItem"]; ?>" class="form-control" id="cantidadServicio" name="cantidadServicio" required readonly></td>
                                            <td>
                                                <textarea rows="5"  class="form-control" id="detalleServicio" name="detalleServicio" required><?php echo $cuerpoDocumento[0]["descripcion"]; ?></textarea>
                                            </td>
                                            <td>
                                                <input type="hidden" size="1" value="<?php echo $cuerpoDocumento[0]["precioUni"]; ?>" class="form-control" id="precioServicio" name="precioServicio" required>
                                                <input type="hidden" size="1" value="<?php echo $resumen["tributos"][0]["valor"]; ?>" class="form-control" id="ivaServicio" name="ivaServicio" required>
                                                <input type="text" size="1" value="<?php echo $resumen["montoTotalOperacion"]; ?>" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <button class="btn btn-primary mt-4 d-inline w-20" type="submit"> Anular <i class="fa fa-arrow-right"></i></button>
                                </div>
                            </div>
