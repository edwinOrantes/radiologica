            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/crear_estructura_ccf" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <input type="text" class="form-control" value="<?php echo $codigoHoja?>" name="codigoHojaCobro">
                                            </td>
                                        </tr>
                                    </table>
                                    <table id="" class="table table-striped thead-primary mt-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" size="1" value="1" class="form-control" id="precioServicio" name="precioServicio" required></td>
                                                <td><input type="text" size="1" value="1" class="form-control" id="ivaServicio" name="ivaServicio" required></td>
                                                <td><input type="text" size="1" value="1" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
