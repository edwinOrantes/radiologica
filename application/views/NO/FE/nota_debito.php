            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/crear_nota_debito" novalidate>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            echo '<tr>
                                                        ...
                                                        <td class="text-center">'.$jsonDTE["dteJson"]["cuerpoDocumento"][0]["descripcion"].'</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea rows="1"  class="form-control" id="descripcionServicio" name="descripcionServicio" required readonly><?php echo $jsonDTE["dteJson"]["cuerpoDocumento"][0]["descripcion"]; ?></textarea>
                                            </td>
...
<script>
    ...
    $(document).on('change', '#precioServicio', function (event) {
        ...
        // Obteniendo valores anteriores
            var subTotalOld = $("#subTotalOld").val();
            var ivaOld = $("#ivaOld").val();
            var totalOld = $("#totalOld").val();
        // Obteniendo valores anteriores
        ...
        // Obteniendo valores nuevos
            $("#subTotalNew").val((subtotal -subTotalOld).toFixed(2));
            $("#ivaNew").val((iva -ivaOld).toFixed(2));
            $("#totalNew").val((total - totalOld).toFixed(2));
        // Obteniendo valores nuevos
