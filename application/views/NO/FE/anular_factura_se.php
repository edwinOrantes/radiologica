                    ...
                    <div class="ms-panel-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="<?php echo base_url()?>Facturacion/lista_se/" class="btn btn-outline-success btn-sm"><i class="fa fa-arrow-left"></i> Volver</a>
                            </div>
                        </div>
                    </div>

                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/procesar_anulacion_se" novalidate>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $datosLocales['complementoPaciente']; ?>" id="complementoPaciente" name="complementoPaciente" >
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                            ...
                                            <select class="form-control" value="<?php echo $cuerpoDocumento[0]["tipoItem"] ?>" id="tipoVenta" name="tipoVenta">
                                                <option value="">.:: Seleccionar ::.</option>
                            ...
                            <div class="row">
                                ...
                                <table id="" class="table table-striped thead-primary">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input size="1" type="text" value="<?php echo $cuerpoDocumento[0]["cantidad"]; ?>" class="form-control" id="cantidadServicio" name="cantidadServicio" required readonly></td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" size="1" value="<?php echo $resumen["totalCompra"]; ?>" class="form-control" id="precioServicio" name="precioServicio" required>
                                                <input type="hidden" size="1" value="<?php echo $resumen["reteRenta"]; ?>" class="form-control" id="ivaServicio" name="ivaServicio" required>
                                                <input type="hidden" size="1" value="<?php echo $resumen["totalPagar"]; ?>" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
$(document).on('change', '#precioServicio', function (event) {
        ...
        if(tipo == ""){
            ...
            $("#precioServicio").val(0);
        }else{
            var monto = parseFloat($(this).val());
            if(tipo == 2){ // Si es de servicios
                iva = monto * 0.10;
                subtotal = monto - iva;
            }else{ // Es de insumos
                iva = 0;
            ...
            $("#totalServicio").val(monto.toFixed(2));
