...
<div class="contenedor">
  ...
  <div class="caja">
        ...
        <table id="tabla_emisor">
            <tr>
                ...
                <td>UNION MEDICA S.A. DE C.V.</td>
            </tr>
            <tr>
                <td><strong>Actividad Economica:</strong></td>
                <td>Actividades de hospital</td>
            </tr>
            <tr>
  ...
  <div class="caja">
        ...
        <table id="tabla_tributaria">
            ...
            <tr>
                <th colspan="4" style="padding: 5px; background:#bfbfbf; font-size: 12px;">NOTA DE CRÉDITO</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3"><?php echo $respuestaHacienda->selloRecibido;?></td>
            </tr>
            <tr>
...
<div class="caja-abajo">
    ...
    <table id="tabla_emisor">
        <tr>
            ...
            <td><strong>NIT:</strong></td>
            <td><?php echo $receptor["nit"]?></td>
            <td><strong>NRC:</strong></td>
            <td><?php echo $receptor["nrc"]?></td>
        </tr>
        ...
        <tr>
            <td><strong>Dirección:</strong></td>
            <td><?php echo $receptor["direccion"]["complemento"]; ?></td>
            <td><strong>Municipio:</strong></td>
            <td>-</td>
            <td><strong>Departamento:</strong></td>
            <td>-</td>
        ...
        <tr>
            <td><strong>Act. económica:</strong></td>
            <td colspan="5"> <?php echo $receptor["descActividad"]; ?> </td>
        </tr>
...
<div class="caja-abajo">
    <p style="font-size: 9px; width: 100%; border-bottom: 1px solid #000000"><strong>Documentos relacionados</strong></p>
    <table id="tabla_emisor">
        <tr>
            <td><strong>Tipo de documento:</strong></td>
            <td style="width: 30px"><?php echo $ccf["tipoDte"]?></td>
            <td><strong>N° de documento:</strong></td>
            <td><?php echo $ccf["numeroControl"]?></td>
            <td><strong>Fecha del documento:</strong></td>
            <td><?php echo $ccf["fecEmi"]?></td>
        </tr>
    </table>
</div>
    ...
    <table id="tabla-detalle">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center"><?php echo number_format($cuerpoDocumento[0]["ventaGravada"], 2); ?></td>
...
<div class="caja-abajo">
    <table id="tabla-detalle">
            <tr>
                ...
                <th>0.00</th>
                <th>0.00</th>
                <th><?php echo number_format($cuerpoDocumento[0]["ventaGravada"], 2); ?></th>
            </tr>
            ...
            <tr>
                ...
                <th></th>
                <th>
                    <?php echo $resumen["tributos"][0]["valor"]; ?>
                </th>
            </tr>
            ...
            <tr>
                ...
                <th></th>
                <th></th>
                <th><?php echo number_format($resumen["montoTotalOperacion"], 2); ?></th>
            </tr>
