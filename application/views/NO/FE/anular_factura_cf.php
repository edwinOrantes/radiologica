                    ...
                    <div class="ms-panel-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <a href="<?php echo base_url()?>Facturacion/lista_facturas/" class="btn btn-outline-success btn-sm"><i class="fa fa-arrow-left"></i> Volver</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="" class="table table-striped thead-primary">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" size="1" value="<?php echo $cuerpoDocumento[0]["precioUni"]; ?>" class="form-control" id="precioServicio" name="precioServicio" required>
                                                <input type="hidden" size="1" value="<?php echo $cuerpoDocumento[0]["ivaItem"]; ?>" class="form-control" id="ivaServicio" name="ivaServicio" required>
                                                <input type="hidden" size="1" value="<?php echo $cuerpoDocumento[0]["ventaGravada"]; ?>" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
