				...
				<div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <input type="checkbox" id="pivoteAmbulatorio" value="ambulatorio" name="ambulatorio">
                                <span class="ms-switch-slider round"></span>
                            </label>
                            <strong> Extranjero </strong>
                            <label class="ms-switch">
                            <input type="checkbox" id="pivoteExtranjero" value="extranjero" name="extranjero">
                                <span class="ms-switch-slider round"></span>
                            </label>
                        </div>
                    </div>
					...
					<form class="needs-validation" method="post" action="<?php echo base_url()?>Paciente/agregar_paciente" novalidate>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control duiPaciente" id="duiPaciente" name="duiPaciente" data-mask="99999999-9" placeholder="DUI del paciente" required>
                            ...
                            <div class="form-group col-md-4">
                             ...
                             <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="ocupacionPaciente" name="ocupacionPaciente" placeholder="Ocupación del paciente" required>
                                <div class="invalid-tooltip">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input value="" class="form-control" id="tipeoPaciente" name="tipeoPaciente">
                                <div class="invalid-tooltip">
                        ...
                        <!-- datos para el responsable -->
                            <div id="datosResponsable">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for=""><strong>Edad</strong></label>
                                        <input type="number" class="form-control numeros" value="0" min="0" id="edadResponsable" name="edadResponsable" placeholder="Edad del paciente"/>
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" value=" " id="profesionResponsable" name="profesionResponsable" placeholder="Profesion del responsable"/>
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for=""><strong>Dirección</strong></label>
                                        <input class="form-control" value=" " id="direccionResponsable" name="direccionResponsable"/>
                                        <div class="invalid-tooltip">
...
<script>
    ...
    $(document).on('click', '#pivoteAmbulatorio', function() {
        var valor = $('input:checkbox[name=ambulatorio]:checked').val();
        if(valor == "ambulatorio"){
            $("#duiPaciente").val("00000000-0");
            $("#telefonoPaciente").val("0000-0000");
            $("#nacimientoPaciente").removeAttr("required");
            $("#civilPaciente").removeAttr("required");
            $("#telefonoPaciente").removeAttr("required");
            $("#ocupacionPaciente").removeAttr("required");
            // $("#sexoPaciente").removeAttr("required");
            $("#tipeoPaciente").removeAttr("required");
            $("#direccionPaciente").removeAttr("required");
            
        }else{
            $("#duiPaciente").attr("required","required");
            $("#nacimientoPaciente").attr("required","required");
            $("#civilPaciente").attr("required","required");
            $("#telefonoPaciente").attr("required","required");
            $("#ocupacionPaciente").attr("required","required");
            // $("#sexoPaciente").attr("required","required");
            $("#tipeoPaciente").attr("required","required");
            $("#direccionPaciente").attr("required","required");

        }
    });

    $(document).on("change", "#edadPaciente", function() {
        var fechaNacimiento = calcularAnioNacimiento($(this).val());
        $("#nacimientoPaciente").val(fechaNacimiento.toISOString().slice(0,10));
    });
    ...
    function calcularAnioNacimiento(edad) {
        ...
        var fechaNacimiento = new Date(anioNacimiento, hoy.getMonth(), hoy.getDate());
    ...
    $(document).on('click', '#pivoteExtranjero', function() {
        var valor = $('input:checkbox[name=extranjero]:checked').val();
        if(valor == "extranjero"){
            $("#duiPaciente").removeAttr("data-mask");
            
        }else{
            $("#duiPaciente").attr("data-mask","99999999-9");
