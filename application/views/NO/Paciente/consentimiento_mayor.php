...
<div class="contenedor">
    <?php $espacios = "&nbsp;&nbsp;&nbsp;"; ?>                    
<p>
YO <span class="resaltar"> <?php echo $espacios.$paciente->nombrePaciente.$espacios; ?> </span> de <span class="resaltar"> 
<?php echo $espacios.$paciente->edadPaciente.$espacios; ?> </span> años de edad, profesión <span class="resaltar"> 
<?php echo $espacios.$paciente->profesionPaciente.$espacios; ?> </span>, del domicilio de <span class="resaltar">
<?php echo $espacios.$paciente->direccionPaciente.$espacios; ?> </span>, 
y con Documento Único de Identidad número <span class="resaltar"> <?php echo $espacios.$paciente->duiPaciente.$espacios; ?> </span> 
...
DOY MI CONSETIMIENTO EXPRESO para la hospitalización y realización de procedimientos médicos y/o quirúrgicos que sean necesarios,   bajo las siguientes especificaciones:</p>
...
<p>Nombre: <span class="resaltar"> <?php echo $espacios.$paciente->nombrePaciente.$espacios; ?> </span></p>
<p>DUI: <span class="resaltar"> <?php echo $espacios.$paciente->duiPaciente.$espacios; ?> </span> </p>
                ...
                <tr>
                    <?php
                        if(isset($responsable)){
                            echo '<td colspan=" 2" style="border-bottom: 1px solid #000; text-align: center"><strong>'.$responsable->parentescoResponsable.'</strong></td>';
                        }else{
                            echo '<td colspan=" 2" style="border-bottom: 1px solid #000; text-align: center">&nbsp;</td>';
                        }
                    ?>
                </tr>
                <tr>
...
<div class="pie">
    <div class="pie_detalle">
        ...
        <div class="pie_izquierda" >
            <table style="width: 90%">
                <tr>
                    <td colspan=" 2" style="border-bottom: 1px solid #000; text-align: center; font-weight: bold"></td>
                </tr>
                <tr>
                    <td colspan=" 2" style="text-align: center; height: 25px">Nombre del Padre/Tutor y/o Representante Legal.</td>
                </tr>
