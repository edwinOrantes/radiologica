		...
		<div class="col-md-12">
			...
			<nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-arrow has-gap">
                    ...
                    <li class="breadcrumb-item"><a href="#">Constancia médica</a></li>
                </ol>
            </nav>
			...
			<div class="ms-panel">
				<div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6"><h6>Listado de constancias médicas </h6></div>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            <div class="ms-panel-body">
                                ...
                                <form class="needs-validation" id="frmConstancia"  method="post" action="<?php echo base_url() ?>Constancias/guardar_constancia"  novalidate>
