                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-arrow has-gap">
                            <li class="breadcrumb-item" aria-current="page"> <a href="#"><i class="fa fa-users"></i> Reportes </a> </li>
				...
				<div class="ms-panel-header">
                    <div class="row">
						<div class="col-md-12">
							...
							<form class="needs-validation" method="post" action="<?php echo base_url(); ?>Honorarios/pivote_pendientes" target="blank" novalidate>
								<div class="row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
												...
												<div class="input-group">
													<select class="form-control controlInteligente" id="tipoReporte" name="tipoReporte" required>
														<option value="">.:: Seleccionar un médico ::.</option>
														<option value="1">Pendientes</option>
														<option value="2">Entregados</option>
													</select>
													<div class="invalid-tooltip">
														Cuales honorarios desea generar.
													</div>  
												</div>
											</div>
                                            ...
                                            <div class="text-center col-md-3">
                                                ...
                                                <div class="invalid-tooltip">
                                                    En que formato los desea generar.
                                                </div> 
                                            </div>
