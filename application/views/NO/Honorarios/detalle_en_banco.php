		...
		<div class="col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-arrow has-gap">
                    <li class="breadcrumb-item" aria-current="page"> <a href="#"><i class="fas fa-list"></i> Honorarios  </a> </li>
			...
			<div class="ms-panel">
				<div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6"><h6>Honorarios depositados en el banco</h6></div>
                        <div class="col-md-6 text-right">
                            <?php
                                if(sizeof($honorarios) > 0){
                                    echo '<a href="#saldarHonorarios" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Saldar honorarios </a>';
                                }
                            ?>
                            ...
                            <table id="tabla-medicamentos" class="table table-striped thead-primary w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="<?php echo base_url(); ?>Hoja/detalle_hoja/<?php echo $row->idHoja?>/" target="_blank"><?php echo $row->codigoHoja; ?></a></td>
                                        <td class="text-center"> <?php echo $row->nombrePaciente; ?> </td>
                                        <td class="text-center">$<?php echo number_format($row->precioExterno, 2); ?></td>
                                        <td class="text-center"><?php echo $row->fechaGenerado; ?></td>
                                    </tr>
                                    <?php } ?>
                        ...
                        <div class="ms-panel ms-panel-bshadow-none">
                            <form class="needs-validation" id="frmGastos" method="post" action="<?php echo base_url(); ?>Honorarios/saldar_honorarios_banco/" novalidate>
                                <div class="form-row">
                                    ...
                                    <input type="hidden" value="<?php echo $pivoteExterno;?>" id="returnPago" name="returnPago" required>
