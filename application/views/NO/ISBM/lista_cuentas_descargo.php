		...
		<div class="col-xl-12 col-md-12">
			<div class="ms-panel">
				<div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6"><h6>Lista de descargos existentes</h6></div>
                        <div class="col-md-6 text-right"><a class="btn btn-success btn-sm" href="<?php echo base_url()?>Isbm/cuenta_descargo/"><i class="fa fa-plus"></i> Crear cuenta </a></div>
                    </div>
				</div>
                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
														<?php
															switch ($cuenta->areaDescargosBM) {
																case 'I':
																	echo '<span class="badge badge-success">ISBM</span>';
																	break;
																case 'L':
																	echo '<span class="badge badge-danger">Laboratorio</span>';
																	break;
																case 'H':
																	echo '<span class="badge badge-danger">Hemodialisis</span>';
																	break;
																case 'E':
																	echo '<span class="badge badge-warning">Empleado</span>';
																	break;
																
																default:
																	echo '<span class="badge badge-primary">Hospital</span>';
																	break;
															}
														?>
													</td>
                                                    ...
                                                    <td class="text-center"><?php echo $cuenta->turnoDescargosBM ?></td>
                                                    <td class="text-center"><?php echo $cuenta->fechaDescargosBM ?></td>
                                                    <td class="text-center">
                                                    <?php
                                                        // if ($cuenta->fechaDescargosBM < date('Y-m-d')) {
                                                        if ($cuenta->estadoDescargosBM == 0) {
                                                    ?>
                                                        <a  title='Ver detalle de la cuenta' href='<?php echo base_url()?>Isbm/detalle_cuenta_descargo/<?php echo $cuenta->idDescargosBM;?>/'><i class='far fa-eye ms-text-success'></i></a>
                                                    <?php
                                                        }else{
                                                    ?>
                                                        <a  title='Ver detalle de la cuenta' href='<?php echo base_url()?>Isbm/detalle_cuenta_descargo/<?php echo $cuenta->idDescargosBM;?>/'><i class='far fa-edit ms-text-primary'></i></a>
                                                    <?php
                                                        }
                                                    ?>
                                                    </td>
