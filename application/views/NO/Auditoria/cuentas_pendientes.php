				...
				<div class="ms-panel-body">
					<div class="row">
						<div class="col-md-8 tade">
                            <a href="<?php echo base_url(); ?>Auditoria/cuentas_pendientes_pdf" class="btn btn-danger" target="blank"><i class="fa fa-file-pdf"></i> PDF</a>
                            <a href="<?php echo base_url(); ?>Auditoria/cuentas_pendientes_excel" class="btn btn-success" target="blank"><i class="fa fa-file-excel"></i> EXCEL</a>
						</div>
					</div>
				</div>
			</div>
