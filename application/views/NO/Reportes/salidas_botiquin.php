		...
		<div class="col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-arrow has-gap">
                    ...
                    <li class="breadcrumb-item"><a href="#">Salidas de botiquín</a></li>
                </ol>
            </nav>
				...
				<div class="ms-panel-body">
                    <div class="row">
						<div class="col-md-8 tade">
							<form class="needs-validation" id="reporteCirugiasFechas" method="post" action="<?php echo base_url()?>Reportes/generar_detalle_movimientos" target="blank" novalidate>
