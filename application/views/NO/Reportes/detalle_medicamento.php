		...
		<div class="col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-arrow has-gap">
                    ...
                    <li class="breadcrumb-item"><a href="#">Detalle medicamentos</a></li>
                </ol>
            </nav>

			<div class="ms-panel">
				<div class="ms-panel-header ms-panel-custome">
                    <h6>Seleccione el rango de fecha y el respectivo medicamento</h6>
				</div>
				<div class="ms-panel-body">
                    <div class="row">
						<div class="col-md-8 tade">
							<form class="needs-validation" id="reporteCirugiasFechas" method="post" action="<?php echo base_url()?>Reportes/generar_detalle_paciente" target="_blank" novalidate>
								<div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <select name="idMedicamento" id="idMedicamento" class="form-control controlInteligente" required>
                                                <option value="">.:: Seleccionar ::.</option>
                                                <?php
                                                    foreach ($medicamentos as $medicamento) {
                                                ?>
                                                    <option value="<?php echo $medicamento->idMedicamento; ?>">
                                                    <?php echo $medicamento->nombreMedicamento; ?></option>
                                                <?php } ?>
                                            </select>
                                            <div class="invalid-tooltip">
