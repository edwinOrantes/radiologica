                            ...
                            <div class="form-row">
                                <div class="col-md-8">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="feriadoMedicamento" name="feriadoMedicamento" placeholder="Precio venta del medicamento fuera de horario" required>
                                                    <div class="invalid-tooltip">
                                                        Ingrese un precio de venta.
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-control" id="destinoMedicamento" name="destinoMedicamento" required>
                                                    <option value="">.:: Seleccionar ::.</option>
                                                    <option value="0" selected>Botiquín </option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control numeros" id="descuentoMedicamento" name="descuentoMedicamento" placeholder="Ejem. 10%" required>
                                                    <div class="invalid-tooltip">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div>
                                            <table class="m-2" id="tablaMedidas">
                                            </table>
                                        </div>
                                    </div>
