                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php 
                                                            if($medicamento->nombreMedida != "Unitario"){
                                                                echo $medicamento->nombreMedicamento.'<span class="badge badge-success">('.$medicamento->nombreMedida.'x'.$medicamento->baseMedida.')</span>'; 
                                                            }else{
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <!-- Campos para operaciones -->
                                                            ...
                                                            <input type="hidden" value="<?php echo $medicamento->idFacturaMedicamento; ?>" class="idFacturaMedicamento">
                                                            <input type="hidden" value="<?php echo $medicamento->stockMedicamento; ?>" class="stockMedicamento">
                                                            <input type="hidden" value="<?php echo $medicamento->cantidad; ?>" class="cantidad"> 
                                                            <input type="hidden" value="<?php echo $medicamento->precio; ?>" class="precio">
                                                            <input type="hidden" value="<?php echo $medicamento->nombreMedida; ?>" class="nombreMedida">
                                                            <input type="hidden" value="<?php echo $medicamento->baseMedida; ?>" class="baseMedida">
                                                            <input type="hidden" value="<?php echo $medicamento->cantidadUnitaria; ?>" class="cantidadUnitaria">
                                                        <!-- Campos para operaciones -->
                                                    </td>
                                                <td class="text-center">
                                                        <?php
                                                        echo "<a class='actualizarDetalle' href='#actualizarMedicamentos' data-toggle='modal'><i class='fas fa-edit ms-text-success'></i></a>";
                                                        echo "<a class='eliminarDetalle' href='#eliminarMedicamentos' data-toggle='modal'><i class='far fa-trash-alt ms-text-danger'></i></a>";
                                                        ?>
                                                    </td>
                                                </tr>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center" scope="row">
                                                                <?php
                                                                    ...
                                                                    if ($medidas === null && json_last_error() !== JSON_ERROR_NONE) {
                                                                        echo '<span class="badge badge-warning">Unitario</span><input type="hidden" value="1" class="form-control medidaInsumo">';
                                                                    } else {
                                                            ...
                                                            <td class="text-center precio">
                                                                ...
                                                                <input type="hidden" value="<?php echo $medicamento->codigoMedicamento; ?>" class="form-control codigoM">
                                                                <input type="hidden" value="<?php echo $medicamento->nombreMedicamento; ?>" class="form-control nombreM">
                                                                <input type="hidden" value="<?php echo $medicamento->precioVMedicamento; ?>" class="form-control precioVM">
                                                                <!-- <input type="hidden" value="<?php echo $medicamento->precioCMedicamento; ?>" class="form-control precioCM"> -->
                                                                <input type="hidden" value="<?php echo $medicamento->stockMedicamento; ?>" class="form-control stockM">
                                                                <input type="hidden" value="<?php echo $facturas->idFactura; ?>" class="form-control facturaM">
                                                                <input type="hidden" value="Unitario" class="form-control nombreMedida">
                                                                <input type="hidden" value="1" class="form-control medidaAUnidades">
                                                            </td>
                        ...
                        <div class="ms-panel ms-panel-bshadow-none">
                            <div class="ms-panel-body">
                                <form class="needs-validation" id="frmMedicamento" method="post" action="<?php echo base_url() ?>Botiquin/actualizar_medicamento_factura" novalidate>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <label for="">Cantidad <strong id="etiquetaMedida"></strong></label>
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" class="form-control" id="baseMedidaU" name="baseMedida" required>
...
<script>
    ...
    $(document).on("change", ".medidaInsumo", function() {
        ...
        if(precio != 0){
            ...
            $(this).closest('tr').find('.medidaAUnidades').val(cantidad);
        }else{
            $(this).closest('tr').find('.nombreMedida').val("Unitario");
            $(this).closest('tr').find('.medidaAUnidades').val("1");
        }
    });
...
<script>
    ...
    $(document).on('click', '.agregarMedicamento', function (event) {
        ...
        var datos = {
            ...
            nombre_medida: $(this).closest('tr').find(".nombreMedida").val(),
            base_medida: $(this).closest('tr').find(".medidaAUnidades").val()
        }
    ...
    $(document).on('change', '.fechaCM', function(e) {
        e.preventDefault();
        $(this).closest("tr").find(".addMed").show();
    });
</script>
...
<!-- Tamaños de tablas -->
    <script>
        ...
        $(document).on('click', ".actualizarDetalle", function(){
            $("#idMedicamento").val($(this).closest('tr').find('.idMedicamento').val());
            $("#idMedicamentoFactura").val($(this).closest('tr').find('.idFacturaMedicamento').val());
            $("#stock").val($(this).closest('tr').find('.stockMedicamento').val());
            $("#cantidadMedicamentoFactura").val($(this).closest('tr').find('.cantidad').val());
            $("#transaccionMedicamento").val($(this).closest('tr').find('.idFacturaMedicamento').val());
            $("#baseMedidaU").val($(this).closest('tr').find('.baseMedida').val());
            var etiqueta = $(this).closest('tr').find('.nombreMedida').val() + '-'+$(this).closest('tr').find('.baseMedida').val()
            $("#etiquetaMedida").html(etiqueta);
        })

        $(document).on('click', ".eliminarDetalle", function(){
            $("#idMedicamentoFacturaE").val($(this).closest('tr').find('.idFacturaMedicamento').val());
        })
