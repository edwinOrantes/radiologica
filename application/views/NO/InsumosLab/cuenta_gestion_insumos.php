				...
				<div class="ms-panel-body">
					<div class="table-responsive">
                        <?php
                            if (sizeof($cuentas) > 0) {
                        ?>
						<table id="tabla-sensos" class="table table-striped thead-primary w-100 tablaHojas">
							<thead>
							...
							<tbody>
								...
								?>
											<tr>
												...
												?>
													<a  title='Ver detalles de la cuenta' href='<?php echo base_url()?>InsumosLab/detalle_cuenta_insumos/<?php echo $cuenta->idCuenta;?>/'><i class='far fa-eye ms-text-success'></i></a>
												<?php
													}else{
												?>
													<a  title='Editar la cuenta' href='<?php echo base_url()?>InsumosLab/detalle_cuenta_insumos/<?php echo $cuenta->idCuenta;?>/'><i class='far fa-edit ms-text-primary'></i></a>
												<?php
													}
												?>
												</td>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            <div class="ms-panel-body">
                                ...
                                <h4 class="text-center">¿Crear cuenta para este dia?</h4>
                                <form class="needs-validation" id="frmMedico"  method="post" action="<?php echo base_url() ?>InsumosLab/crear_cuenta_insumos"  novalidate>
