        ...
        <div class="col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-arrow has-gap">
                    ...
                    <li class="breadcrumb-item"><a href="#">Gestión descuentos </a></li>
                </ol>
            </nav>
            ...
            <div class="ms-panel">
                <div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Listado de descuentos</h6>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="#agregarDescuento" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Agregar descuento </a>
                        </div>
                    </div>
                </div>
                <div class="ms-panel-body">
                    <div class="row">
                        <div class="table-responsive mt-3">
                            ...
                            ?>
                                <table id="tblDescuentos" class="table table-striped thead-primary w-100 tablaPlus">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center"  style="display:none;"><?php echo $row->idDP; ?></td>
                                                <td class="text-center"><?php echo $row->nombreDP; ?></td>
                                            </tr>
                                        <?php
                                            }
                                        ?>
                ...
                <div class="modal-body p-0 text-left">
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            <form class="needs-validation" id="frmGastos" method="" novalidate>
                                    
                                <div class="row mt-3">
                                    <div class="form-group col-md-12">
                                        <label for=""><strong>Nombre</strong></label>
                                        <input type="text" class="form-control" id="nombreDescuento" name="nombreDescuento" placeholder="Nombre del descuento." required>
                                        <div class="invalid-tooltip">
                                            Debes ingresar el nombre del descuento.
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group text-center">
                                    <button type="button" class="btn btn-primary has-icon" id="guardarDescuento"><i class="fa fa-save"></i> Agregar </button>
...
<script>
    $(document).on("click", '#guardarDescuento', function(e) {
        // e.preventDefault();
        // var salario = $(this).closest("tr").find('.salarioBEmpleado').val();
        var descuento = $('#nombreDescuento').val();
        if(descuento != ""){
            var datos = {
                nombre : descuento,
            }
            $.ajax({
                    url: "../guardar_info_descuento",
                    type: "POST",
                    beforeSend: function () { },
                    data: datos,
...
<script>
    $(document).ready(function() {
        $('#tblDescuentos').Tabledit({
                url: '../editar_descuento',
                columns: {
                    identifier: [0, 'fila'],
                    editable: [[1, 'idD'], [2, 'nombreD']]
                },
                restoreButton:false,
                deleteButton:false,
            });
