                            ...
                            <div id="reciboGenerado" class="">
                                <?php 
                                    if($paciente->correlativoSalidaHoja > 0){
                                        ...
                                        echo $cod = $this->session->userdata('global') == 1 ? " " : '<h6 class="text-danger">Recibo generado Nº '.$paciente->correlativoSalidaHoja.'</h6>';
                                     }
                        ...
                        <div class="col-md-8 text-right">
                            ...
                            ?>
                                <!-- Si la hoja esta abierta o no -->
                                    ...
                                    ?>
                                    <!-- Nueva forma de agregar medicamentos -->
                                        <!-- <div class="btn-group">
                                            <button type="button" onclick="cambiar(1)" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                Medicamentos e insumos
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#medicamentosInsumos" data-toggle="modal">Botiquín</a></li>
                                                <li><a class="dropdown-item" href="#stockEmergencia" data-toggle="modal">Stock emergencia</a></li>
                                                <li><a class="dropdown-item" href="#cp1" data-toggle="modal">Caja de paro 1</a></li>
                                                <li><a class="dropdown-item" href="#cp2" data-toggle="modal">Caja de paro 2</a></li>
                                                <li><a class="dropdown-item" href="#cp3" data-toggle="modal">Caja de paro 3</a></li>
                                                <li><a class="dropdown-item" href="#cp4" data-toggle="modal">Caja de paro 4</a></li>
                                            </ul>
                                        </div> -->
                                    <!-- Nueva forma de agregar medicamentos -->
                                    ...
                                    <!-- Seccion mostrada solo a cajera -->
                                        ...
                                        ?>
                                             <!-- <a href="#numeroConsumidorFinal" data-toggle="modal" class="btn btn-primary text-white"><i class="fa fa-file"></i> Consumidor final</a> -->
                                            <!-- 
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item btnRecibo" href="<?php echo base_url(); ?>Hoja/recibo_hoja/<?php echo $paciente->idHoja; ?>">Recibo</a></li>
                                                    <!-- <li><a class="dropdown-item" href="#consumidorFinal" data-toggle="modal">Recibo y factura</a></li>
                                                    <li><a class="dropdown-item" href="#numeroConsumidorFinal" data-toggle="modal">Agregar número</a></li> -->
                                                    <?php
                                                        if($paciente->credito_fiscal == ""){
                                                            echo '<li><a class="dropdown-item" href="#crearFactura" data-toggle="modal">Factura Electrónica</a></li>';
                                                            echo '<li><a class="dropdown-item" href="#agregarNumeroFactura" data-toggle="modal">Agregar números</a></li>';
                                                        }else{
                                                            $urlF = base_url()."Facturacion/";
                                                            switch ($paciente->notaFactura) {
                                                                case 'Consumidor final':
                                                                    $urlF .= 'fin_factura_electronica/'.$paciente->credito_fiscal.'/0/';
                                                                    break;
                                                                case 'Sujeto excluido':
                                                                    $urlF .= 'fin_se/'.$paciente->credito_fiscal.'/0/';
                                                                    break;
                                                                
                                                                default:
                                                                $urlF .= 'fin_ccf/'.$paciente->credito_fiscal.'/0/';
                                                                    break;
                                                            }
                                                            echo '<li class="alert-success"><a class="dropdown-item" target="blank" href="'.$urlF.'"> Facturado: "'.$paciente->notaFactura.'"</a></li>';
                                                            echo '<li><a class="dropdown-item" href="#agregarNumeroFactura" data-toggle="modal">Quitar número</a></li>';
                                                        }
                                                    ?>
                                        ...
                                        <?php }else{
                                            if( $this->session->userdata("global") == 4){
                                                ...
                                                if($paciente->credito_fiscal == ""){
                                                    echo '<li><a class="dropdown-item" href="#agregarNumeroFactura" data-toggle="modal">Agregar número</a></li>';
                                                }else{
                                                    $urlF = base_url()."Facturacion/";
                                                    switch ($paciente->notaFactura) {
                                                        case 'Consumidor final':
                ...
                <div class="ms-panel-body">
                        ...
                        <table class="table table-borderless">
                            <?php
                                if($paciente->pagaMedico == 1){
                                    echo '<tr class="bg-danger text-white text-center">';
                                    echo    '<td colspan="6"><strong>Nota: </strong> La cuenta sera cancelada por el médico: '.$paciente->responsableHoja.'</td>';
                                    echo '</tr>';
                                }
                            ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        if($this->session->userdata('id_usuario_h') > 0){
                                ...
                                <td><?php echo $cod = $this->session->userdata('global') == 1 ? $paciente->seguimientoHoja : $paciente->codigoHoja; ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        echo $paciente->salidaHoja == "" ? "Aun ingresado" : $paciente->salidaHoja;
                                    ?>
                                </td>
                                <?php } ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div id="editable-label">
                                        <label id="labelProcedimiento"><?php echo $paciente->procedimientoHoja; ?></label>
                                        <span id="editIcon" onclick="editarProcedimiento()">
                                            <i class="fa fa-pen text-primary"></i>
                                        </span>
                                        <input type="text" class="form-control" id="inputProcedimiento" style="display:none;">
                                        <span id="checkIcon" onclick="editarProcedimiento()" style="display:none;">
                            ...
                            <tr>
                                ...
                                <?php
                                    if($paciente->porPagos == 0){
                                        if($this->session->userdata("nivel") == 1 || $this->session->userdata("nivel") == 5){
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in active show" id="tab1">
                                                <div class="medicamentosContainer">
                                                    <table class="table table-hover thead-primary tblM tablaMedicamentos" id="tblMedicamentos">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-center" id="comienzo">Desde</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="move">
                                                                ...
                                                                <td class="text-center">
                                                                    <?php
                                                                        switch ($medicamento->pivoteStock) {
                                                                            case '1':
                                                                                echo '<span class="badge badge-outline-warning text-sm">CP-1</span>';
                                                                                break;
                                                                            case '2':
                                                                                echo '<span class="badge badge-outline-warning text-sm">CP-2</span>';
                                                                                break;
                                                                            case '3':
                                                                                echo '<span class="badge badge-outline-warning text-sm">CP-3</span>';
                                                                                break;
                                                                            case '4':
                                                                                echo '<span class="badge badge-outline-warning text-sm">CP-4</span>';
                                                                                break;
                                                                            case '5':
                                                                                echo '<span class="badge badge-outline-warning text-sm">E</span>';
                                                                                break;
                                                                                
                                                                            default:
                                                                                echo '<span class="badge badge-danger">B</span>';
                                                                                break;
                                                                        }
                                                                    ?>
                                                                </td>

                                                                <td class="text-center precioMedicamento"><?php echo $medicamento->nombreMedicamento." <span class='badge badge-outline-info text-sm badge-sm'>".$medicamento->nombreMedida."</span>"; ?>  </td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <!-- <input type="hidden" class="form-control txtCantidad" id="cantidad" name="cantidadMedicamento" value="<?php echo $medicamento->cantidadInsumo; ?>" required="" > -->
                                                                    ...
                                                                    <input type="hidden" class="form-control txtCantidadMG" name="cantidadMG" value="<?php echo $medicamento->cantidadMG; ?>" required="">
                                                                    ...
                                                                    <?php
                                                                        // Proceso con validacion anterior que incluia proceso de salas
                                                                        ...
                                                                        if($medicamento->pivoteStock == 0){
                                                                            // echo "<a onclick='actualizarMedicamentos($id, $idM, $cantidad, $tipo, $transaccion)' href='#actualizarMedicamentos' data-toggle='modal' title='Cambiar medicamento'><i class='fas fa-retweet ms-text-success'></i></a>";
                                                                            echo "<a href='#actualizarMedicamentos' class='cambiarMedicamento' data-toggle='modal' title='Cambiar medicamento'><i class='fas fa-retweet ms-text-success'></i></a>";
                                                                        }
                                                                        echo "<a class='eliminarDetalle' data-toggle='modal' title='Eliminar medicamento'><i class='far fa-trash-alt ms-text-danger'></i></a>";
                                                                    ?>
                                                                </td>
                    ...
                    <!-- Menu opciones -->
                        ...
                        <menu class="items-wrapper">
                            ...
                            <?php
                                if($paciente->correlativoSalidaHoja == 0 || $this->session->userdata("acceso_h") == 1 ){
                                    echo '<a href="#agregarDescuento" data-toggle="modal" class="menu-item" title="Agregar historia clinica"> <i class="fa fa-file-medical"></i> </a>';
                                }
                                ...
                                echo '<a href="'.base_url().'Paciente/editar_paciente/'.$paciente->idPaciente.'" target="blank" class="menu-item" title="Actualizar datos del paciente"><i class="fa fa-user-edit"></i></a>';
                    ...
                    <?php
                        if( $this->session->userdata("acceso_h") == 10 || $this->session->userdata("acceso_h") == 1 || $this->session->userdata("acceso_h") == 2){
                            if($paciente->credito_fiscal != ' ' && $paciente->notaFactura != '' ){
                                /* $ip = $_SERVER['REMOTE_ADDR'];
			                    $base_url2 = "http://".$ip."/".'sirius/';
                                echo '<td><a href="'.$base_url2.'Home/recibo_factura/'.$paciente->idHoja.'/0/" target="_blank" title="Imprimir factura" class="btn btn-danger text-white btn-flotante"><i class="fa fa-print"></i></a></td>'; */
                                ...
                                echo '<td><a href="'.$urlF.'" target="blank" title="Cuenta facturada" class="btn btn-danger text-white btn-flotante"><i class="fa fa-print"></i></a></td>';
...
<!-- Modales -->
    <!-- Modal credito fiscal-->
        <div class="modal fade" id="crearFactura" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white"> <i class="fa fa-file"></i> Tipo de documento</h4>
                    ...
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-bshadow-none">
                                <div class="ms-panel-body">
                                    <p class="text-danger h5"><strong>¿Estas seguro de continuar con el proceso?</strong></p><br>
                                    <form class="needs-validation" id="frmMedicamento" method="post" action="" novalidate>
                                        <?php
                                            $data["idHoja"] = $paciente->idHoja;
                                            foreach($documentos as $row){                                       
                                                $data["idDetalleCatalogo"] = $row->idDetalleCatalogo;
                                                $data["codigoCatDetalle"] = $row->codigoCatDetalle;
                                                $data["valorCatDetalle"] = $row->valorCatDetalle;

                                                $params = urlencode(base64_encode(serialize($data)));
                                        ?>
                                            <a class="btn btn-outline-primary btn-block mb-1" href="<?php echo base_url(); ?>Facturacion/crear_factura/<?php echo $params; ?>/">
                                                <?php echo $row->valorCatDetalle; ?>
                                            </a><br>
                                        <?php }  ?>

                                        <a class="btn btn-outline-primary btn-block mb-1" href="<?php echo base_url(); ?>Facturacion/agregar_ccf/<?php echo $paciente->codigoHoja; ?>/">
                                            Crédito fiscal
                                        </a><br>
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" scope="col">Por</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    foreach ($medicamentos as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            ...
                                                            if($turno == 1){
                                                                // Turno normal se toma precio normal
                                                                if($paciente->seguroHoja >= 9 && $paciente->seguroHoja <= 12){
                                                                    if($medicamento->descuentoMedicamento != 0){
                                                                        $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * ($medicamento->descuentoMedicamento/100)), 2);
                                                                    }else{
                                                                    ...
                                                                    if($medicamento->tipoMedicamento != "Medicamentos"){
                                                                        ...
                                                                        $precioFinal = round($medicamento->precioVMedicamento, 2);
                                                                    }
                                                                }
                                                            }else{
                                                                // Turno fuera de horario se toma precio feriado

                                                                if($paciente->seguroHoja >= 9 && $paciente->seguroHoja <= 12){
                                                                    
                                                                    if($medicamento->descuentoMedicamento != 0){
                                                                        $precioFinal = round($medicamento->feriadoMedicamento + ($medicamento->feriadoMedicamento * ($medicamento->descuentoMedicamento/100)), 2);
                                                                    }else{
                                                                    ...
                                                                    if($medicamento->tipoMedicamento != "Medicamentos"){
                                                                        ...
                                                                        $precioFinal = round($medicamento->feriadoMedicamento, 2);
                                                                    }
                                                                }
                                                ...
                                                <tr class="filaMedicamento">
                                                    ...
                                                    <td class="text-center" scope="row">
                                                         <?php
                                                            $medidas = json_decode($medicamento->medidas, true);
                                                            if ($medidas === null && json_last_error() !== JSON_ERROR_NONE) {
                                                                echo '<span class="badge badge-warning">Unidad</span><input type="hidden" value="1" class="form-control medidaInsumo">';
                                                            } else {
                                                                echo '<select class="form-control medidaInsumo">';
                                                                echo '<option value="0"> --- </option>';
                                                                foreach ($medidas as $row) {
                                                                    echo '<option value="'.$row['precio'].'">'.$row['nombreMedida'].'-'.$row['cantidad'] . '</option>';
                                                                }
                                                                echo '</select>';
                                                            }
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- <?php
                                                            ...
                                                            // }
                                                        ?> -->
                                                        <input type="hidden" value="1"class="form-control cantidadM" />
                                                        <input type="text" value="1"class="form-control cantidadMG" />
                                                        <input type="hidden" value="Unidad"class="form-control nombreMedida" />

                                                        <input type="hidden" value="<?php echo $paciente->idHoja?>"class="form-control hojaHM" />
                                                        <input type="hidden" value="<?php echo $paciente->fechaHoja?>"class="form-control fechaHM" />
                                                    </td>
                                                    ...
                                                    <td class="text-center" scope="row">
                                                        ...
                                                        <?php
                                                            if($medicamento->precioEditable == 1){
                                                                echo '<input type="text" value="'.$precioFinal.'" class="form-control precioM" />';
                                                            }else{
                                                                echo '<input type="text" value="'.$precioFinal.'" class="form-control precioM" readonly/>';
                                                            }
                                                        ?>
                                                        
                                                        <input type="hidden" value="<?php  echo $precioFinal; ?>" class="form-control precioBM" />
                                                    </td>
                                ...
                                <div class="ms-panel-body">
                                    <form class="needs-validation" id="frmMedicamento" method="post" action="<?php echo base_url() ?>Hoja/actualizar_medicamento" novalidate>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div id="medidaMedicamentoNuevo"></div>
                                            </div>

                                            <div class="col-md-12">
                                                <label for=""><strong>Cantidad</strong></label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control numeros" value="1" id="cantidadInsumo" name="cantidadInsumoNuevo" placeholder="Ingrese la nueva cantidad" required>
                                                    
                                                    <!-- Datos del medicamento actual -->
                                                        <input type="hidden" class="form-control" id="idHojaInsumoV" name="idHojaInsumo" required>
                                                        <input type="hidden" class="form-control" id="idMV" name="idMedicamentoViejo" required>
                                                        <input type="hidden" class="form-control" id="cantidadV" name="cantidadMedicamentoViejo" required>
                                                        <input type="hidden" class="form-control" id="cantidadMG" name="cantidadMGViejo" required>
                                                        <input type="hidden" class="form-control" id="transaccionV" name="transaccion" required>
                                                    <!-- Datos del medicamento actual -->
                                                        
                                                     <!-- Datos del nuevo medicamento -->
                                                        <input type="hidden" class="form-control" id="baseNuevaMedida" name="baseNuevaMedida" required>
                                                        <input type="hidden" class="form-control" id="nombreNuevaMedida" name="nombreNuevaMedida" required>
                                                        <input type="hidden" class="form-control" id="precioNuevoMedicamento" name="precioNuevoMedicamento" required>
                                                    <!-- Datos del nuevo medicamento -->
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pb-5">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="text-danger"><strong>Nota: </strong>Revisar si hay cobro de "Uso de clínica"</p>
                    </div>
                ...
                <div class="modal-content ms-modal-content-width">
                    ...
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-bshadow-none">
                                <div class="ms-panel-body">
                                    <form class="needs-validation" id="frmMedicamento" method="post" target="_blank" action="<?php echo base_url() ?>Hoja/guardar_consumidor_final" novalidate>
                                        ...
                                        ?>                  
                                        <div class="text-center">
                                            <input type="hidden" value="1" name="pivoteFacturaRecibo" />
                                        ...
                                        <div class="text-center">
                                            ...
                                            <input type="hidden" value="0" name="pivoteFacturaRecibo" />
    ...
    <!-- Modal agrgar numero consumidor final -->
        <div class="modal fade" id="numeroConsumidorFinal" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <!-- <h6 class="modal-title text-white"> <i class="fa fa-file"></i> Factura de Consumidor Final</h6> -->
                    ...
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-bshadow-none">
                                <div class="ms-panel-body">
                                    <form class="needs-validation" id="frmMedicamento" method="post" target="_blank" action="<?php echo base_url() ?>Hoja/guardar_numero_cf" novalidate>
    ...
    <!-- Fin modal agrgar numero consumidor final -->
    ...
    <!-- Modal para agregar procedimiento -->
        <div class="modal fade" id="agregarDescuento" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Agregar descuento</h4>
                    ...
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-bshadow-none">
                                <div class="ms-panel-body">
                                    <!-- Inio -->
                                    <form class="needs-validation" id="frmAgregarDescuento" method="post" action="<?php echo base_url(); ?>Hoja/guardar_descuento/" novalidate="">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12" id="responsableFamiliar"></div>
                                        </div>

                                        <div class="text-center">
                                            <input type="hidden" value="<?php echo $paciente->idHoja; ?>" name="hojaCobro">
        ...
        <div class="modal fade p-5" id="pagaraMedico" tabindex="-1" role="dialog" aria-labelledby="modal-5">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pb-5">
                    ...
                    <form class="needs-validation px-3" action="<?php echo base_url()?>Hoja/pagara_medico" method="post">
                        <input type="text" class="form-control" value="<?php echo $paciente->nombreMedico; ?>" placeholder="Detalle" name="detallePago" required>
                        <input type="hidden" id="" value="<?php echo $paciente->idHoja; ?>" name="idHoja"><br>
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary shadow-none"><i class="fa fa-sync-alt"></i> Cambiar </button>
                        </div>
                    </form>
                ...
                <div class="modal-content pb-5">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <form class="needs-validation" action="<?php echo base_url()?>Hoja/actualizar_monto_paquete" method="post">
                            ...
                            <input type="hidden" id="" value="<?php echo $paciente->idHoja; ?>" name="idHoja">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary shadow-none close"><i class="fa fa-save"></i> Guardar </button>
                            </div>
                        </form>
                    </div>
...
<!-- Nuevos modales para stocks -->
    <!-- Modal para agregar medicamentos de la caja de paro -Nivel 1 -->
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="cp1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Caja de paro -Nivel 1</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="text-white">&times;</span></button>
                    </div>
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                <?php
                                                    $precioFinal = 0;
                                                    $porcentaje  = $paciente->porcentajeSeguro/100;
                                                    foreach($stockCaja1 as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            $precioFinal = 0;
                                                            if($turno == 1){
                                                                $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * $porcentaje), 2);
                                                ...
                                                <tr class="filaMedicamento">
                                                    ...
                                                    <td class="text-center" scope="row"><?php echo $medicamento->nombreMedicamento; ?></td>
                                                    <td class="text-center" scope="row">
                                                        <input type="hidden" value="<?php echo $medicamento->idMedicamento; ?>" id="" class="form-control idM" />
                                                        <input type="hidden" value="<?php echo $medicamento->nombreMedicamento; ?>" id="" class="form-control nombreM" />
                                                        <input type="text" value="<?php  echo $precioFinal; ?>" id="" class="form-control precioM" />
                                                    </td>
                                                    <td>
                                                        <input type="text" value="1" id="" class="form-control cantidadM" />
                                                        <input type="hidden" value="<?php echo $paciente->idHoja?>" id="" class="form-control hojaHM" />
                                                        <input type="hidden" value="<?php echo $paciente->fechaHoja?>" id="" class="form-control fechaHM" />
                                                        <input type="hidden" value="<?php echo $medicamento->idStock; ?>" id="" class="form-control stockHM" />
                                                    </td>
                                                    <td class="text-center">
                                                        <?php
                                                            echo "<a class='ocultarAgregar agregarDesdeStock' title='Agregar a la lista'><i class='fa fa-plus ms-text-primary'></i></a>";
                                                        ?>
                                                    </td>
                                                </tr>
                                                <?php   } } ?>
    ...
    <!-- Fin Modal para agregar medicamentos de la caja de paro -Nivel 1 -->

    <!-- Modal para agregar medicamentos de la caja de paro -Nivel 2 -->
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="cp2" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Caja de paro -Nivel 2</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="text-white">&times;</span></button>
                    </div>
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                <?php
                                                    $precioFinal = 0;
                                                    $porcentaje  = $paciente->porcentajeSeguro/100;
                                                    foreach($stockCaja2  as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            $precioFinal = 0;
                                                            if($turno == 1){
                                                                $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * $porcentaje), 2);
    ...
    <!-- Fin Modal para agregar medicamentos de la caja de paro -Nivel 2 -->

    <!-- Modal para agregar medicamentos de la caja de paro -Nivel 3 -->
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="cp3" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Caja de paro -Nivel 3</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="text-white">&times;</span></button>
                    </div>
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                <?php
                                                    $precioFinal = 0;
                                                    $porcentaje  = $paciente->porcentajeSeguro/100;
                                                    foreach($stockCaja3  as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            $precioFinal = 0;
                                                            if($turno == 1){
                                                                $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * $porcentaje), 2);
    ...
    <!-- Fin Modal para agregar medicamentos de la caja de paro -Nivel 3 -->

    <!-- Modal para agregar medicamentos de la caja de paro -Nivel 4 -->
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="cp4" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Caja de paro -Nivel 4</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="text-white">&times;</span></button>
                    </div>
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                <?php
                                                    $precioFinal = 0;
                                                    $porcentaje  = $paciente->porcentajeSeguro/100;
                                                    foreach($stockCaja4  as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            $precioFinal = 0;
                                                            if($turno == 1){
                                                                $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * $porcentaje), 2);
    ...
    <!-- Fin Modal para agregar medicamentos de la caja de paro -Nivel 4 -->

    <!-- Modal para agregar medicamentos de la caja de paro -Nivel 4 -->
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="stockEmergencia" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog ms-modal-dialog-width">
                <div class="modal-content ms-modal-content-width">
                    <div class="modal-header  ms-modal-header-radius-0">
                        <h4 class="modal-title text-white">Caja de paro -Emergencias</h4>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="text-white">&times;</span></button>
                    </div>
                    <div class="modal-body p-0 text-left">
                        <div class="col-xl-12 col-md-12">
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                <?php
                                                    $precioFinal = 0;
                                                    $porcentaje  = $paciente->porcentajeSeguro/100;
                                                    foreach($stockCaja5  as $medicamento) {
                                                        if($medicamento->ocultarMedicamento == 0){
                                                            $precioFinal = 0;
                                                            if($turno == 1){
                                                                $precioFinal = round($medicamento->precioVMedicamento + ($medicamento->precioVMedicamento * $porcentaje), 2);
...
<!-- Modal credito fiscal-->
    <div class="modal fade" id="agregarNumeroFactura" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header  ms-modal-header-radius-0">
                    <h4 class="modal-title text-white"> <i class="fa fa-file"></i> Selecione los datos</h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true"><span
                            aria-hidden="true" class="text-white">&times;</span></button>
                </div>
                ...
                <div class="modal-body p-0 text-left">
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            <div class="ms-panel-body">
                                <form class="needs-validation" method="post"  action="<?php echo base_url() ?>Hoja/guardar_numero_facturacion" novalidate>

                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <label for=""><strong>Número de factura</strong></label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="" name="numeroFactura">
                                                <div class="invalid-tooltip">
                                                    Ingrese el número de factura.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <label for=""><strong>Tipo de factura</strong></label>
                                            <div class="input-group">
                                        ...
                                        <div class="text-center col-md-12">
                                            <input type="hidden" value="<?php echo $paciente->idHoja; ?>" name="hojaFactura">
                                            <button class="btn btn-primary btn-block mt-4" type="submit"><i class="fa fa-save"></i> Actualizar datos</button>
                                        </div>
                                    <div>
                                </form>
                            </div>
...
<!-- Script JS para agregar un medicamento -->
    <script>
        ...
        $(document).on("change", ".medidaInsumo", function() {
            var precio = $(this).val();
            if(precio != 0){
                ...
                $(this).closest('tr').find('.nombreMedida').val(nombre);
                $(this).closest('tr').find('.cantidadM').val(cantidad);
                $(this).closest('tr').find('.precioM').val(precio);
            }else{
                $(this).closest('tr').find('.nombreMedida').val("Unidad");
                $(this).closest('tr').find('.cantidadM').val("1");
                $(this).closest('tr').find('.precioM').val($(this).closest('tr').find('.precioBM').val());
            }
        });

        $(document).on("change", ".medidaInsumoNuevo", function() {
            var precio = $(this).val();
            if(precio != 0){
                var texto = $(this).find('option:selected').text().split('-');
                var nombre = texto[0];
                ...
                /* var precio_unitario = (parseFloat(precio)/parseFloat(cantidad)).toFixed(2);
                $(this).closest('tr').find('.cantidadM').val(cantidad); */
                $('#nombreNuevaMedida').val(nombre);
                $('#baseNuevaMedida').val(cantidad);
                $('#precioNuevoMedicamento').val(precio);
        ...
        $(document).on('click', '.agregarMedicamento', function(event) {
            ...
            var cantidadMG = $(this).closest('tr').find(".cantidadMG").val();
            ...
            var datos = {
                ...
                cantidad: cantidadMG, // Cantidad para visualizacion
                idHoja: $(this).closest('tr').find(".hojaHM").val(),
                fechaHoja: $(this).closest('tr').find(".fechaHM").val(),
                cantidadMG: (cantidad * cantidadMG), // Cantidad para hacer descargos
                cantidadBase: cantidad,
                nombreMedida: $(this).closest('tr').find(".nombreMedida").val()
        ...
        $(document).on("click", ".cambiarMedicamento", function() {
            $("#idHojaInsumoV").val($(this).closest('tr').find('.txtIdHoja').val());        // Id hoja-insumo
            $("#idMV").val($(this).closest('tr').find('.txtIdM').val());                // Id del medicamento actual
            $("#cantidadV").val($(this).closest('tr').find('.txtCantidad').val());      // Cantidad del medicamento actual
            $("#transaccionV").val($(this).closest('tr').find('.txTransaccion').val());// Id hoja-insumo
            $("#cantidadMG").val($(this).closest('tr').find('.txtCantidadMG').val());// Id hoja-insumo
        });


        $(document).on("change", "#nuevoMedicamento", function(e) {
            var datos = {
                medicamento : $(this).val()
            };

            $.ajax({
                url: "../../validar_medicamento_nuevo",
                type: "POST",
                beforeSend: function () { },
                data: datos,
                success:function(respuesta){
                        ...
                        if (registro.length > 0){
                            var index = 0;
                            var select = '';
                            select += '<label for=""><strong>Medida</strong></label>';
                            select += '<div class="input-group">';
                            select += '<select class="medidaInsumoNuevo form-control">';
                            for (var i = 0; i < registro.length; i++) {
                                index++;
                                // Recorriendo medidas
                                    select += '    <option value="'+registro[i]["precioVMedicamento"]+'">Unidad-1</option>';
                                if(registro[i]["medidas"] && registro[i]["medidas"].trim() !== ''){
                                    var medidas = JSON.parse(registro[i]["medidas"]);
                                ...
                                // Iterar sobre los elementos del arreglo
                                $("#precioNuevoMedicamento").val(registro[i]["precioVMedicamento"]);
                            }
                            select += '</select>';
                            select += '<div class="invalid-tooltip">';
                            select += '        Seleccione el medicamento o insumo.';
                            select += '    </div>';
                            select += '</div>';
                            $("#medidaMedicamentoNuevo").html(select);
                            $("#nuevaCantidad").val("1");
                            $("#baseNuevaMedida").val("1");
                            $("#nombreNuevaMedida").val("Unidad");
                        }
                },
                error:function(){
                    alert("Hay un error");
...
<script src="<?php echo base_url(); ?>public/js/agregar_desde_stocks.js"> </script>