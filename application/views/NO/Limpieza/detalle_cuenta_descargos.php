		...
		<div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ol class="breadcrumb breadcrumb-arrow has-gap">
                            <li class="breadcrumb-item" aria-current="page"> <a href="#"><i class="fa fa-list-alt"></i> Almacén </a> </li>
			...
			<div class="ms-panel">
				<div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-success btn-sm" href="<?php echo base_url()?>Limpieza/descargos_insumos/"><i class="fa fa-arrow-left"></i> Volver </a>
                        </div>
                        <div class="col-md-6 text-right">
                            <?php
                                /* if($filaCuenta->fechaCuenta == date('Y-m-d') ){
                            ...
                            <table id="tablag" class="table table-striped thead-primary w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $fila->codigoInsumoLimpieza; ?></td>
                                        <td class="text-center"><?php echo $fila->nombreInsumoLimpieza." <span class='badge badge-primary'>".$fila->entregadoA."</span> "; ?></td>
                                        <td class="text-center"><?php echo $fila->cantidadInsumo; ?></td>

                                        <?php
                                            if($filaCuenta->estadoCuenta == 1){
                                        ?>
                                            <td class="text-center" style="display: none;"><?php echo $fila->idInsumoLimpieza; ?></td>
                                            <td class="text-center" style="display: none;"><?php echo $fila->idDescargosLimpieza; ?></td>
                                        ...
                                        <table id="" class="table table-striped thead-primary w-100 tabla-medicamentos">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $insumo->nombreInsumoLimpieza; ?></td>
                                                    <td><span class="badge badge-primary"> <?php echo $insumo->unidadInsumoLimpieza; ?> </span></td>
                                                    <td class="text-center">
                                                        <input type="hidden" value="<?php echo $insumo->idInsumoLimpieza; ?>" class="form-control idIns menosHeight" />
    ...
    <div class="modal fade p-5" id="cerrarCuenta" tabindex="-1" role="dialog" aria-labelledby="modal-5">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pb-5">
                    ...
                    <form class="needs-validation" action="<?php echo base_url()?>Limpieza/cerrar_cuenta_descargos" method="post">
