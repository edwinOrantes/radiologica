		...
		<div class="col-md-12">
			...
			<div class="ms-panel">
				...
				<div class="ms-panel-body">
					<div class="row">
						<div class="col-md-12">
							<form class="needs-validation" method="post" action="<?php echo base_url(); ?>Limpieza/guardar_compra" novalidate>
									...
									<div class="col-md-4">
										...
										<div class="input-group">
											<select class="form-control" id="tipoFactura" name="tipoFactura" required>
                                                ...
                                                <option value="Compra de medicamentos" selected="true">Compra de Insumos</option>
                                            </select>
								...
								<div class="form-row">
									...
									<div class="col-md-4">
										...
										<div class="input-group">
                                        <input type="text" class="form-control" id="proveedorFactura" name="proveedorFactura" placeholder="Proveedor" required>
											<div class="invalid-tooltip">
                                    ...
                                    <div class="col-md-4">
										...
										<div class="input-group">
											<select name="plazoFactura" id="plazoFactura" class="form-control" required>
												<option value="">.:: Seleccionar ::.</option>
												<option value="0" selected="true">Contado</option>
