                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/procesar_anulacion_se" novalidate>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" size="1" value="<?php echo $resumen["reteRenta"]; ?>" class="form-control" id="ivaServicio" name="ivaServicio" required>
                                                <input type="text" size="1" value="<?php echo $resumen["totalPagar"]; ?>" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <input type="text" value="<?php echo $datosLocales['codigoDepartamento']; ?>" class="form-control" id="codigoDepartamento" name="codigoDepartamento">
                            <input type="text" value="<?php echo $datosLocales['codigoMunicipio']; ?>" class="form-control" id="codigoMunicipio" name="codigoMunicipio">
                            <input type="text" value="<?php echo $datosLocales['codigoActividadEconomica']; ?>" class="form-control" id="codigoActividadEconomica" name="codigoActividadEconomica">
