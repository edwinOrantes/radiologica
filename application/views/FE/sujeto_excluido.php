            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/sellar_sujeto_excluido" novalidate>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            echo '<tr>
                                                        ...
                                                        <td class="text-center"> $'.number_format($totalI, 2).'
                                                            <input type="text" value="'.round($iva, 2).'" id="ivaI" name="ivaI">
                                                            <input type="text" value="'.round($subTotal, 2).'" id="subTotalI" name="subTotalI">
                                                            <input type="text" value="'.round($totalI, 2).'" id="totalInterno" name="totalInterno"></td>
                                                    </tr>';
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><span id="tdTotalGlobal">$<?php echo number_format($totalI, 2); ?></span>
                                                <input type="text" value="<?php echo round($totalI, 2) ?>" id="totalGlobal" name="totalGlobal"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            ?>
                                <div class="row">
                                    <input type="text" value="<?php echo $paciente->idPaciente; ?>" id="idPaciente" name="idPaciente">
                                    <input type="text" value="<?php echo $paciente->idHoja; ?>" id="idHoja" name="idHoja">
                            ...
                            <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/actualizar_anexo_paciente" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6" style="display: none">
                                        ...
                                        <input type="text" class="form-control" value="" id="nrcPaciente" name="nrcPaciente" placeholder="Documento del paciente">
                                        <div class="invalid-tooltip">
                                ...
                                <div class="form-group text-center mt-3">
                                    ...
                                    <input type="text" value="<?php echo @$anexo->codigoMunicipio; ?>" class="form-control" id="codigoActividadEconomica" name="codigoActividadEconomica">
