								...
								<table id="" class="table table-striped thead-primary w-100 insumos-lab">
									...
									?>
										<tr class="<?php echo $clase; ?>">
                                            ...
                                            <td>
												<a href="<?php echo base_url(); ?>Facturacion/fin_nota_credito/<?php echo $row->idDTEFC; ?>/" target="_blank" title="Ver nota de crédito"><i class="fa fa-file text-success"></i></a>
