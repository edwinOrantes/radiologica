                    ...
                    <div class="ms-panel-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Facturacion/lista_facturas"><i class="fa fa-file"></i> Lista facturas</a>
                            </div>
                        </div>
                    </div>

                    <div class="ms-panel-body">
                        <form class="needs-validation" target="_blank" method="post" action="<?php echo base_url()?>Facturacion/crear_estructura_cf" novalidate>

                            <!-- Datos del emisor -->
                                <div class="row">
                                    <div class="col-md-6 alert-primary p-1">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="" id="documentoPaciente" name="documentoPaciente" placeholder="Documento del paciente" required>
                                            <div class="invalid-tooltip">
