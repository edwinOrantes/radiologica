                    ...
                    <div class="ms-panel-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a class="btn btn-outline-success btn-sm" href="<?php echo base_url()?>Facturacion/lista_se"><i class="fa fa-arrow-left"></i> Volver </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <!-- Contingencia -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" value="" id="tipoContingencia" name="tipoContingencia">
                                                        <option value=""></option>
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="" id="documentoPaciente" name="documentoPaciente" placeholder="Documento sin guiones" required>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                            ...
                                            <select class="form-control" value="" id="departamentoPaciente" name="departamentoPaciente" required>
                                                <option value="">.:: Seleccionar ::.</option>
                                                <?php
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                            ...
                                            <select class="form-control" value="" id="municipioPaciente" name="municipioPaciente" required>
                                        ...
                                        <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                            ...
                                            <select class="form-control" value="" id="tipoVenta" name="tipoVenta" required>
                                                <option value="">.:: Seleccionar ::.</option>
                            ...
                            <!-- Detalle -->
                                <div class="row">
                                    ...
                                    <table id="" class="table table-striped thead-primary mt-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input size="1" type="text" value="1" class="form-control" id="cantidadServicio" name="cantidadServicio" required readonly></td>
                                                <td>
                                                    <textarea rows="5"  class="form-control" id="detalleServicio" name="detalleServicio" required></textarea>
                                                </td>
                                                <td>
                                                    <input type="text" size="1" value="1" class="form-control" id="precioServicio" name="precioServicio" required>
                                                    <input type="hidden" size="1" value="1" class="form-control" id="ivaServicio" name="ivaServicio" required>
                                                    <input type="hidden" size="1" value="1" class="form-control" id="totalServicio" name="totalServicio" required readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
