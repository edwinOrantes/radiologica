            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/procesar_anulacion_ccf" novalidate>
                                ...
                                <div class="col-md-4 alert-danger ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipoAnulacion" name="tipoAnulacion" required>
                                            <option value=""></option>
                                            <option value="1" style="display: none">Error en la información del Documento Tributario Electrónico a invalidar</option>
                                            <option value="2">Rescindir de la operacion realizada</option>
                                            <option value="3" style="display: none">Otro</option>
                                        </select>
                                        <div class="invalid-tooltip">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for=""><strong>Actividad económica </strong> <span id="spanCodigoActividadEconomica" class="badge badge-success"><?php echo $receptor["codActividad"] ?></span> </label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                        ...
                                        <select class="form-control" value="" id="tipoDocumento" name="tipoDocumento" required>
                                            <option value="">.:: Seleccionar ::.</option>
                                            <option value="36" selected>NIT</option>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="documentoPaciente" name="documentoPaciente" value="<?php echo $receptor["nit"] ?>" required>
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control"  value="<?php echo $receptor["nrc"] ?>" id="nrcPaciente" name="nrcPaciente" placeholder="Documento del paciente">
                                        <div class="invalid-tooltip">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                        <label for=""> <strong>Departamento</strong> <span id="spanDepartamento" class="badge badge-success"> <?php echo $receptor["direccion"]["departamento"] ?> </span></label>
                                    ...
                                    <div class="form-group col-md-4 col-sm-12 cl-lg-6">
                                        <label for=""> <strong>Municipio</strong> <span id="spanMunicipio" class="badge badge-success"><?php echo $receptor["direccion"]["municipio"] ?></span></label>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $receptor["direccion"]["complemento"] ?>" id="complementoPaciente" name="complementoPaciente" >
                                        <div class="invalid-tooltip">
                            ...
                            <div class="row">
                                ...
                                <table id="" class="table table-striped thead-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><input size="1" type="text" value="<?php echo $row["cantidad"]; ?>" class="form-control" id="cantidadServicio" name="cantidadServicio[]" readonly></td>
                                            <td>
                                                <input value="<?php echo $row["descripcion"]; ?>"  class="form-control" id="detalleServicio" name="detalleServicio[]" readonly>
                                            </td>
                                            <td>
                                                <input type="text" size="1" value="<?php echo $row["precioUni"]; ?>" class="form-control" id="precioServicio" name="precioServicio[]" readonly>
                                                <input type="hidden" size="1" value="<?php echo $row["precioUni"] * 0.13; ?>" class="form-control" id="ivaServicio" name="ivaServicio" readonly>
                                                <input type="hidden" size="1" value="<?php echo $row["ventaGravada"]; ?>" class="form-control" id="totalServicio" name="totalServicio" readonly></td>
                                        </tr>
                                        <?php
                                                $index++;
                                            }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    <button class="btn btn-primary mt-4 d-inline w-20" type="submit"> Anular documento <i class="fa fa-arrow-right"></i></button>
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="<?php echo $datosLocales['codigoDepartamento']; ?>" class="form-control" id="codigoDepartamento" name="codigoDepartamento">
                            <input type="hidden" value="<?php echo $datosLocales['codigoMunicipio']; ?>" class="form-control" id="codigoMunicipio" name="codigoMunicipio">
                            <input type="hidden" value="<?php echo $datosLocales['codigoActividadEconomica']?>" class="form-control" id="codigoActividadEconomica" name="codigoActividadEconomica">
