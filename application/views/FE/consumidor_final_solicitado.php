            ...
            <div class="col-md-12"> 
                ...
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation" method="post" action="<?php echo base_url()?>Facturacion/sellar_cf_solicitado" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <table id="" class="table table-striped thead-primary mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center"><?php echo $row["cantidad"]; ?><input size="1" type="hidden" value="<?php echo $row["cantidad"]; ?>" class="form-control" id="cantidadServicio" name="cantidadServicio[]" required></td>
                                                <td class="text-center">
                                                    <?php echo $row["descripcion"]; ?>
                                                </td>
                                                <td class="text-center">
                                                    <?php echo round($row["precio"], 2); ?>
                                                    <input type="hidden" value="<?php echo $row["descripcion"]; ?>"  class="form-control" id="detalleServicio" name="detalleServicio[]" required>
                                                    <input type="hidden" size="1" value="<?php echo round($row["precio"], 5); ?>" class="form-control" id="precioServicio" name="precioServicio[]" required>
