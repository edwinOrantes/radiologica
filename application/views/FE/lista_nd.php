			...
			<div class="col-md-12">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb breadcrumb-arrow has-gap">
						...
						<li class="breadcrumb-item"><a href="#">Lista de notas de débito </a></li>
					</ol>
				</nav>
					...
					<div class="ms-panel-header">
						...
						<div class="col-md-6"><h6>Historial</h6></div>
							<div class="col-md-6 text-right">
									<a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Facturacion/lista_ccf/"><i class="fa fa-plus"></i> Agregar Nota de debito</a>
							</div>
						</div>
					</div>
								...
								<table id="" class="table table-striped thead-primary w-100 insumos-lab">
									...
									<?php
										...
										foreach ($lista as $row) {
                                            ...
                                            $respuestaHacienda = unserialize(base64_decode(urldecode($row->respuestaHacienda)));
									...
									?>
										<tr class="<?php echo $clase; ?>">
											...
											<td class="text-center"> <?php echo $respuestaHacienda->selloRecibido; ?> </td>
                                            ...
                                            <td>
												<a href="<?php echo base_url(); ?>Facturacion/fin_nota_debito/<?php echo $row->idDTEFC; ?>/" target="_blank" title="Ver nota de crédito"><i class="fa fa-file text-success"></i></a>
												
												<?php
													// Evaluando si hay nota de credito o debito
													if($row->padreDTE > 0){
														echo '<a class="" href="'.base_url().'Facturacion/fin_ccf/'.$row->padreDTE.'/0/" target="_blank" title="Ver crédito fiscal"><i class="fa fa-file text-danger"></i></a>';
													}
												?>
