					...
					<div class="ms-panel-header">
						<div class="row">
							...
							<div class="col-md-6 text-right">
									<a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Facturacion/agregar_sujeto_excluido/"><i class="fa fa-plus"></i> Agregar factura</a>
							</div>
						</div>
					</div>
								...
								<table id="" class="table table-striped thead-primary w-100 insumos-lab">
									...
									?>
										<tr class="">
											...
											<td class="text-center"><?php echo $jsonDTE["dteJson"]["sujetoExcluido"]["nombre"]; ?></td>
											...
											<td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
														<li><a class="dropdown-item" target="blank" href="<?php echo base_url(); ?>Facturacion/fin_se/<?php echo $row->idDTEFC; ?>/0/">Ver</a></li>
														<?php
															if($row->estadoDTE == 1){
														?>
														<li><a class="dropdown-item" href="<?php echo base_url(); ?>Facturacion/anular_se/<?php echo $row->idDTEFC; ?>/">Anular</a></li>
														<?php
															}
														?>
												...
												<?php
													if($row->enContingencia == 1){
														echo '<a href="'.base_url().'Facturacion/se_en_contingencia/'.$row->idDTEFC.'/" target="_blank" class="text-primary" title="Enviar documento"> <i class="fa fa-check"> </i></a>';
													}
												?>		
