					...
					<div class="ms-panel-header">
						<div class="row">
							...
							<div class="col-md-6 text-right">
									<a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>Facturacion/agregar_ccf/"><i class="fa fa-plus"></i> Agregar CCF</a>
							</div>
						</div>
					</div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
														<li><a class="dropdown-item" target="blank" href="<?php echo base_url(); ?>Facturacion/fin_ccf/<?php echo $row->idDTEFC; ?>/V/">Ver</a></li>
														<?php
															if($row->estadoDTE == 1){
														?>
