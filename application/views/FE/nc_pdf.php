    ...
    <table id="tabla-detalle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center"><?php echo number_format($row["precioUni"], 5); ?></td>
                <td style="text-align: center"> </td>
                <td style="text-align: center"> </td>
                <td style="text-align: center"> </td>
                <td style="text-align: center"><?php echo number_format($row["ventaGravada"], 5); ?></td>
            </tr>
            <?php
                    $index++;
                }
...
<div class="caja-abajo">
    <table id="tabla-detalle">
            <tr>
                ...
                <th>0.00</th>
                <th>0.00</th>
                <th><?php echo number_format($resumen["subTotal"], 2); ?></th>
            </tr>
            ...
            <tr>
                ...
                <th>
                    <?php 
                        ...
                        echo number_format($tributos[0]["valor"], 2);
                    ?>
                </th>
            </tr>
