...
<div class="contenedor">
  ...
  <div class="caja">
        ...
        <table id="tabla_tributaria">
            ...
            <tr>
                <th colspan="4" style="padding: 5px; background:#bfbfbf; font-size: 12px;">COMPROBANTE DE CRÉDITO FISCAL</th>
            </tr>
            <tr>
...
<div class="caja-abajo">
    ...
    <table id="tabla_emisor">
        ...
        <tr>
            <td><strong>Dirección:</strong></td>
            <td><?php echo isset($datosLocales["complementoPaciente"]) ? $datosLocales["complementoPaciente"] : $datosLocales["direccionPaciente"]  ; ?></td>
            <td><strong>Municipio:</strong></td>
            <td>
                <?php 
        ...
        <tr>
            ...
            <td colspan="5">
                <?php 
                if(isset($datosLocales["codigoActividadEconomica"])){
                    $act = explode("-", $datosLocales["codigoActividadEconomica"]);
                }else{
                    $act = explode("-", $datosLocales["actividadEconomica"]);
                }
                    echo $act[1]; 
                ?>
            </td>
