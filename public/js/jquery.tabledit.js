        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<span class="fa fa-edit text-white"></span>',
                    action: 'edit'
                },
                delete: {
                    class: 'btnEliminar btn btn-sm btn-danger',
                ...
                editable: function() {
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            // Create span element.
                            var span = '<span class="tabledit-span txt'+ settings.columns.editable[i][1] +'">' + text + '</span>';
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<input class="tabledit-input '+ settings.columns.editable[i][1] +' '+ settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                            }
